...
function related_units(ajax_url, means_name, ajax_id, related_data_tag){
...
$('#id_means_new_failure').change(function () {
  ...
  console.log("////////////////////// MEANS NAME //////////////////////" + means_name);
  var unit_name = $("#id_unit_new_failure").find(':selected')[0].label;

  related_units('/ajax/get_unit_types/', means_name, '#id_unit_new_failure', 'units')
...
$('#id_unit_new_failure').change(function () {
  ...
  //  $("#id_unit_new_failure").find('option').remove().end()
